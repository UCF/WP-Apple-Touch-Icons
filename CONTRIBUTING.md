# Contributing to WP Apple Touch Icons

Thank you for your interest in contributing to this project!  This document outlines the best ways to submit new ideas or inform us of bugs.  Please take a moment to review these guidelines before submitting new issues or pull requests in order to make the contribution process easy and effective for everyone involved.
...
The [issue tracker](https://github.com/UCF/WP-Apple-Touch-Icons/issues) in Github is the preferred channel for [bug reports](#bug-reports), [feature requests](#feature-requests) and [submitting pull requests](#pull-requests).
...
2. **Check if the issue has been fixed** &mdash; if you're not running the latest version of the plugin, please check your code against the repo's `master` branch first (`master` will always contain the latest, stable project code). If you are running the latest version, make sure the problem isn't already resolved in an upcoming [milestone](https://github.com/UCF/WP-Apple-Touch-Icons/milestones).

### Submit a bug report
If you've followed the steps above and have a valid bug report to submit, you can submit it by [creating a new issue in Github](https://github.com/UCF/WP-Apple-Touch-Icons/issues/new?template=bug_report.md).
...
You can submit a new feature request by [creating a new issue in Github](https://github.com/UCF/WP-Apple-Touch-Icons/issues/new?template=feature_request.md) and filling out the provided template.
...
2. Clone your fork, and configure the remotes:
   ...
   git clone https://github.com/<your-username>/WP-Apple-Touch-Icons.git

   # Navigate to the newly cloned directory
   cd WP-Apple-Touch-Icons

   # Assign the original repo to a remote called "upstream"
   git remote add upstream https://github.com/UCF/WP-Apple-Touch-Icons.git
   ```
...
5. Commit your changes in logical chunks. Please provide [helpful, readable commit messages](https://chris.beams.io/posts/git-commit/) (avoid nondescriptive messages such as "bugfix" or "minor change").
    ...
    If you're making changes to scss or js files, make sure you're minifying **and committing** those minified file changes.  scss and js file processing should be performed using gulp commands provided in the repo (see [gulpfile.js](https://github.com/UCF/WP-Apple-Touch-Icons/blob/master/gulpfile.js))
...
If you have a general question about the plugin or need help with using this plugin on your site, check our [project readme](https://github.com/UCF/WP-Apple-Touch-Icons/blob/master/README.md) first.  If you can't find the answer to your question there, please drop us a line in the [#help-plugins Slack channel](https://ucf-wp.slack.com/messages/help-plugins/).  You don't need to @mention anyone specific, but **please note that you're using the WP Apple Touch Icons plugin when posting your question** and include a link to your site if it's relevant to your question.
